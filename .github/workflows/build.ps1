...
msbuild "/p:Configuration=Release_BundledPCRE" "/p:Platform=$arch" "/p:WindowsTargetPlatformVersion=10.0.18362.0" "/p:useenv=true" "win32\vs$($vs.substring(2))\glib.sln"
